...
const seePassBtn = document.querySelectorAll("see-pass");
const passwordInput = document.querySelector(".password");
seePassBtn.forEach(btn => {
  btn.addEventListener.addEventListener("click", (e) => { 
    let input = e.target.previousElmentSibling
        passwordInput.type =
