...
const seePassBtns = document.querySelectorAll(".see-pass");

seePassBtns.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    // هات الانبوت اللي جنب الزرار
    let input = e.target.document.querySelector(".password")
