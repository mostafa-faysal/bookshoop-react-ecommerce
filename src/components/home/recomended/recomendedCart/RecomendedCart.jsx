    ...
    <div className="flex justify-center w-full h-auto md:h-full">
      <div className="flex flex-col md:flex-row gap-5 justify-center items-center w-[90%]">
        ...
        {recomendedBooks.map((book) => (
          <div
            className="flex flex-col md:flex-row gap-4 p-4 md:p-6 w-full md:w-[50%] bg-white shadow-sm items-stretch h-auto md:h-[40vh] mx-auto"
            key={book.id}
          >
            <div className="w-[70%] md:w-48 mx-auto h-[250px] md:h-full shrink-0">
              <ProductImage
                image={book.image}
                title={book.title}
                id={book.id}
